...
実行例:
    .venv/bin/python .agents/skills/dads-pptx/examples/build_anim_example.py /tmp/anim_example.pptx
    .venv/bin/python .agents/skills/dads-pptx/scripts/dads_anim.py /tmp/anim_example.pptx
"""
import sys, os
